...
- `date` should be added in the next format, (you have an example of how to do
  ...
  `tsx <time datetime="2022-09-08" data-cy="date"> September 8, 2022 </time> `
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Anastasiya145.github.io/react_article/) and add it to the PR description.
