...
Implement the `Article` component that takes `title`, `date`, and `` as props
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://maly-oleksandr.github.io/react_article/) and add it to the PR description.
