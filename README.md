# React article
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://vova-myronenko.github.io/react_article/)
- Follow the [React task guideline](https://github.com/mate-academy/react_task-guideline#react-tasks-guideline)

## Task
Implement `Article` component which accepts the next props:
