...
const articeDate = date;
const dateISO = articeDate.toISOString().slice(0, 10);
const dateLocaleString = articeDate.toLocaleDateString('en-US', {
  year: 'numeric',
  month: 'long',
  day: 'numeric',
});
