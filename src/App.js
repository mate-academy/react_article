...
const App = () => (
  <>
    ...
    <Article
      ...
      // A round to develop and mass produce
      // Hall-effect plasma thrusters for small satellites.
      // Material Impact, a venture capital firm focused on early-stage
      // investments, led the round, with
      // Invest Michigan, Invest Detroit, Wakestream Ventures,
      ...
      // including Accion Systems in Boston,
